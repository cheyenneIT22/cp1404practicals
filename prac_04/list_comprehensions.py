...
numbers_greater_than_9 = [int(almost_numbers[2]) for numbers in almost_numbers if int(numbers[2]) > 9]
...
last_names = ', '.join([name.split()[1] for code, name, number in names if len(name) > 11])
print(last_names)
